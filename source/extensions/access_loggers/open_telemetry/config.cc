...
::Envoy::AccessLog::InstanceSharedPtr AccessLogFactory::createAccessLogInstance(
  ...
  // gRPC transport: use top-level grpc_service or common_config.grpc_service (deprecated).
